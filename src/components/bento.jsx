...
const Bento = ({ cols, rows, textHeader, headerColor, bodyColor, bodyText }) => {
    ...
    return (
        <>
    <div className={`${cols} ${rows} ${bodyColor} z-50 transition-all ease-in bg-inherit h-fill hover:-translate-y-1 hover:scale-105 justify-center shadow-lg rounded-md mx-2`}>
