...
export default function Home() {
  return (
    <>  
        ...
        <Bento key="about" cols="col-span-2" rows="row-span-1" textHeader="about me" headerColor="bg-[url('../public/city.jpeg')]" bodyColor="stdGray" bodyText={[`${Math.floor((new Date() - new Date('2008-07-02')) / (1000 * 60 * 60 * 24 * 365.25))} year old high school student`, <br></br>, "Massachusetts native", <br></br>, "INTP 5w4 sx/sp"]} />
        ...
        <Bento key="billboard" cols="col-span-2" rows="row-span-1" textHeader="Todo" headerColor="bg-[url('../public/leaves.webp')]" bodyColor="stdGray" bodyText="get drivers license', get into college" />
