...
export default function Home() {
  return (
    <>  
        ...
        <Bento key="about" cols="col-span-2" rows="row-span-1" textHeader="about me" headerColor="bg-[url('../public/city.jpeg')]" bodyColor="stdGray" bodyText={["17 year old high school student", <br></br>, "Massachusetts native", <br></br>, "INTP 5w4 sx/sp"]} />
